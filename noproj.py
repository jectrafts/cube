...
# --- Quaternion & projection logic included below ---
class Quaternion:
    @classmethod
...
# --- Your Cube and InteractiveCube class code goes here ---
# Paste everything from the Cube class down through InteractiveCube
# Exactly as in your original second message

# --- Replace this final section (entry point) with: ---
